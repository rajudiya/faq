...
namespace Seofeb\Faq\Block\Index;
...
use Seofeb\Faq\Api\FaqGroupRepositoryInterface;
use Seofeb\Faq\Helper\Data as HelperData;
use Seofeb\Faq\Model\Config\DefaultConfig;
use Seofeb\Faq\Model\FaqGroupFactory;
use Seofeb\Faq\Model\ResourceModel\Faq\CollectionFactory;
use Seofeb\Faq\Model\ResourceModel\FaqGroup\Collection as FaqGroupCollection;
use Seofeb\Faq\Model\ResourceModel\FaqGroup\CollectionFactory as FaqGroupCollectionFactory;
...
class Index extends Template implements BlockInterface
{
     ...
     * @var string
     */
    protected $_template = 'Seofeb_Faq::faq_main.phtml';
     ...
     *
     * @param $group
     * @return \Seofeb\Faq\Model\ResourceModel\Faq\Collection
